...
export const testsRepository: TestsRepositoryType = {
    ...
    test2: [
        ...
        },
        {
            ...
            id: "t2q7", topic: "Price Elasticity Midpoint Analysis", text: "Subscription packages compress cost indices down from £20 to £16. Volume counts simultaneously expand from 50k items to 65k items. Calculate the precise price elasticity using the midpoint rule.", options: [{ val: "A", label: "-1.17" }, { val: "B", label: "-0.95" }, { val: "C", label: "-1.35" },
            { val: "D", label: "-0.82" }], correctAnswer: "A", explanation: "% Change Volume = 15k / 57.5k = 26.09%. % Change Price = -4 / 18 = -22.22%. Elasticity index = 26.09% / -22.22% = -1.17."
        }, {
            id: "t2q8", topic: "Operating Leverage Factor Shifts", text: "A sales unit drives volume shifts across operations. If fixed costs track at £300,000 and variable costs stay flat at 40% of standard gross receipts, analyze the target break-even milestone revenue.", options: [{ val: "A", label: "£500,000" }, { val: "B", label: "£450,000" }, { val: "C", label: "£600,000" }, { val: "D", label: "£750,000" }],
            correctAnswer: "A", explanation: "Break-even Revenue = Fixed Costs / Contribution Margin Ratio = 300,000 / (1 - 0.40) = 300,000 / 0.60 = £500,000."
            ...
            id: "t2q10",
            topic: "Retention Rate Growth Formulas", text: "An enterprise records Return on Equity (ROE) indicators tracking at exactly 15%. If management distributes 40% of its net earnings as shareholder dividends, what is the sustainable growth rate score?", options: [{ val: "A", label: "9.0%" }, { val: "B", label: "6.0%" }, { val: "C", label: "10.5%" }, { val: "D", label: "7.5%" }], correctAnswer: "A", explanation: "Retention Rate = 100% - Dividend Payout = 100% - 40% = 60%. Sustainable Growth Rate = ROE * Retention Rate = 15% * 0.60 = 9.0%."
        }]
};